...
::Windows::UI::Xaml::Markup::IXamlType^ ::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider::CreateXamlType(::Platform::String^ typeName)
{
    ...
    if (typeName == L"App2.DemoMapPage")
    {
        ...
        userType->Activator =
            []() -> Platform::Object^ 
            {
                return ref new ::App2::DemoMapPage(); 
            };
...
{
    if (longMemberName == L"App2.DemoMapPage.NavigationHelper")
    {
        ...
        xamlMember->Getter =
            ...
            {
                auto that = (::App2::DemoMapPage^)instance;
    ...
    if (longMemberName == L"App2.DemoMapPage.DefaultViewModel")
    {
